...
[TestFixture]
internal sealed class String_is_empty
{
    ...
    [Test]
    public void Validation_is_succeeded_if_value_is_empty()
    {
        // Arrange.
        var validator = new ModelValidator();
        var model = new Model<string>(string.Empty);
    ...
    [Test]
    public void Validation_is_failed_if_value_is_not_empty()
    {
        // Arrange.
        var validator = new ModelValidator();
