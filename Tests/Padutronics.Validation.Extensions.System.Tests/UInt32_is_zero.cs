...
[TestFixture]
internal sealed class UInt32_is_zero
{
    private sealed class ModelValidator : Validator<Model<uint>>
    {
        protected override void BuildRuleSet(IRuleSetBuilder<Model<uint>> ruleSetBuilder)
        {
