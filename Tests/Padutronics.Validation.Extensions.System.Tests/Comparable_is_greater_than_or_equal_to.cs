...
[TestFixture]
internal sealed class Comparable_is_greater_than_or_equal_to
{
    private sealed class ModelValidator : Validator<Model<int>>
    {
        protected override void BuildRuleSet(IRuleSetBuilder<Model<int>> ruleSetBuilder)
        {
            ruleSetBuilder.Property(model => model.Value)
                ...
                .WithMessage("Value must be greater than or equal to 2.");
        }
    }

    [Test]
    public void Validation_is_failed_if_value_is_less_than_specified()
    {
        // Arrange.
    ...
    [Test]
    public void Validation_is_succeeded_if_value_is_greater_than_specified()
    {
        // Arrange.
        var validator = new ModelValidator();
